...
const Review = () => {
  ...
  return (
    <div className="p-10 md:p-14 bg-[#1C4670] font-[Inter]">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3 justify-center items-center">
          <button className="text-4xl bg-[#FFFFFF] p-1 text-[#1478F1] rounded-full focus:bg-[#FFA229]">
      ...
      <div className="md:flex gap-5 mt-10">
        {profileData.map((data) => {
          return (
            <div className="mt-5 md:mt-0 bg-[#FFFFFF] border-2 border-[#FCDDEC] p-4 rounded-md">
              <div className="flex justify-between items-center">
              ...
              <div className="mt-4 md:flex gap-4 items-center">
                ...
                />
                <div>
                  <h1 className="text-[#3C2109] text-lg font-bold">
                    {data.h1}
                  </h1>
                  <h2 className="text-[#282728] font-normal text-xs">
                    {data.h2}
                  </h2>
                </div>
              </div>
